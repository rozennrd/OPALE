...
exports.generateEdtMacro = void 0;
const exceljs_1 = __importDefault(require("exceljs"));
const path_1 = __importDefault(require("path"));
const holidaysAndWeek_1 = require("../tools/holidaysAndWeek");
const generateEdtMacro = (data) => __awaiter(void 0, void 0, void 0, function* () {
    // Set date to lundi
    ...
    //Get holidays
    const publicHolidays = yield (0, holidaysAndWeek_1.getPublicHolidays)(data.DateDeb.getFullYear());
    const holidays = yield (0, holidaysAndWeek_1.getHolidays)("Bordeaux", data.DateDeb.getFullYear());
    let i = 0;
    ...
    while (currentDate < data.DateFin) {
        ...
        let rowData = {
            weekNumber: (0, holidaysAndWeek_1.getWeekNumber)(currentDate),
...
exports.generateEdtMacro = generateEdtMacro;
